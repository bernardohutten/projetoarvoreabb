...
public class ArvoreABB {
    ...
    public void exibirFormatoArvore(No no) {
        exibirFormatoArvore(no, "", true);
    }

    private void exibirFormatoArvore(No no, String prefixo, boolean ehUltimo) {
        if (no != null) {
            ...
            boolean temFilhoEsquerda = no.esquerda != null;
            boolean temFilhoDireita = no.direita != null;

            if (temFilhoEsquerda || temFilhoDireita) {
                if (no.esquerda != null)
                    exibirFormatoArvore(no.esquerda, novoPrefixo, no.direita == null);
                if (no.direita != null)
                    exibirFormatoArvore(no.direita, novoPrefixo, true);
            }
        }
    }
