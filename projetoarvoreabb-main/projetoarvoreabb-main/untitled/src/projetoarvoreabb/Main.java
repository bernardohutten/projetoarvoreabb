...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5 - Exibir (1-Pré | 2-In | 3-Pós | 4-Visualizar | 5-VisualizarRamificações)");
            ...
            switch (opcao) {
                ...
                case 5:
                    ...
                    System.out.println("4 - Visualizar árvore horizontal");
                    System.out.println("5 - Visualizar árvore com ramificações");
                    ...
                    switch (tipo) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            System.out.println("Visualização horizontal:");
                            arvore.exibirGraficamente(arvore.raiz, 0);
                            break;
                        case 5:
                            System.out.println("Visualização com ramificações:");
                            arvore.exibirFormatoArvore(arvore.raiz);
                            break;
                        default:
